...
ps.Search = function(){
	ps.getDataGridDailyTotalFeeSummary();
}
...
ps.getDataGridDailyTotalFeeSummary = function(){
    ps.loading(true);
    ...
    $("#DailyTotalFeeSummary").html("");
    $("#DailyTotalFeeSummary").kendoGrid({
            dataSource: {
                    transport: {
                        read: {
                            url: url,
...
$(document).ready(function () { 
    ...
    $("#export").click(function (e) {
        var grid = $("#DailyTotalFeeSummary").data("kendoGrid");
        grid.saveAsExcel();
    });
});